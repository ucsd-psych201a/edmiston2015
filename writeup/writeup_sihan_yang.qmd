...
#### Pilot Test (for Project Checkpoint A)

We conducted pilot tests involving three participants. All data are collected using the [online experiment link](https://ucsd-psych201a.github.io/edmiston2015/). The data is available [here]( https://github.com/ucsd-psych201a/edmiston2015/tree/main/data). 
...
# incongruent takes longer than congruent (b = 28.7)
# label takes shorter than congruent (b = -15.52)
# incongruent takes longer than label (b = 44.3) 
```
The result suggests that `r `model_full.pluck(emm_df[emm_df$congruency == "specific_value", ], "estimate")`
