...
#### Pilot Test (for Project Checkpoint B)
...
We set the threshold for data inclusion at 90% accuracy. Four out of five participants in pilot B have achieved an acceptable performance (above 90%). The following is the code to further filter the data based on accuracy (for future use).
