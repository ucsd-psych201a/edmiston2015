...
We conducted pilot tests involving three participants. The following code preprocesses the data and fits a linear mixed model for response time under different conditions: (1) label cue matches the image, (2) auditory cue matches the image but is incongruent, and (3) auditory cue matches the image and is congruent.
...
folder_path <- "/Users/sihanyang/Desktop/courses/PSYC201A/edmiston2015/data"
